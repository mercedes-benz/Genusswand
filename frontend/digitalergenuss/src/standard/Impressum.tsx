...
const Impressum: React.FC = () => {
    return (
        <Box sx={{p: 3}}>
            <div className='impressum'><h1>Impressum</h1><p>Angaben gemäß § 5 DDG</p><p>Simon Berndt <br/>
                Fuchssteige 15<br/>
                89518 Heidenheim <br/>
            </p><p><strong>Kontakt:</strong> <br/>
                E-Mail: <a href='mailto:info@simonberndt.de'>info@simonberndt.de</a><br/>
                Telefon: 01522 4706007 </p><br/>
                <p><strong>Haftungsausschluss: </strong><br/><br/><strong>Haftung für Inhalte</strong><br/><br/>
                    ...
                    gemäß
                    § 7 Abs.1 DDG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich.
                    Nach §§
